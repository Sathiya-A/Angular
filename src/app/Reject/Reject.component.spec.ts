...
describe('RejectComponent', () => {
  ...
  let mockRejectService;
  let mockDataService

  beforeEach(async(() => {

    mockRejectService = sinon.createStubInstance(RejectService);
    mockRejectService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: RejectService, useValue: mockRejectService },
