...
describe('AcceptComponent', () => {
  ...
  let mockAcceptService;
  let mockDataService

  beforeEach(async(() => {

    mockAcceptService = sinon.createStubInstance(AcceptService);
    mockAcceptService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: AcceptService, useValue: mockAcceptService },
